...
if ( ! function_exists( 'gruene_setup' ) ) :
	...
	function gruene_setup() {
		 ...
		 * @see add_image_size()
		 */
		add_image_size( 'gruene_large_post_thumbnail', gruene_get_full_image_width(), 233, array(
			'center',
			'center'
		) );
...
if ( ! function_exists( 'gruene_widgets_init' ) ) :
	...
	function gruene_widgets_init() {
		register_sidebar( array(
			...
			'description'   => __( 'Put only the "Search" or "Cybo Social Sharing" widget in here.', 'gruene' ),
