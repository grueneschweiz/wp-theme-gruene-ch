	...
	function gruene_the_site_icon_fallback() {
		...
		if ( false == (bool) $icon ) {
            ...
            <link rel="apple-touch-icon" sizes="180x180"
                  href="/<?php echo get_stylesheet_directory_uri(); ?>img/favicon/apple-touch-icon.png?v=00rdjbaPyz">
            <link rel="icon" type="image/png"
                  href="<?php echo get_stylesheet_directory_uri(); ?>/img/favicon/favicon-32x32.png?v=00rdjbaPyz"
                  sizes="32x32">
            <link rel="icon" type="image/png"
                  href="<?php echo get_stylesheet_directory_uri(); ?>/img/favicon/favicon-16x16.png?v=00rdjbaPyz"
                  sizes="16x16">
            <link rel="manifest"
                  href="<?php echo get_stylesheet_directory_uri(); ?>/img/favicon/manifest.json?v=00rdjbaPyz">
            <link rel="mask-icon"
                  href="<?php echo get_stylesheet_directory_uri(); ?>/img/favicon/safari-pinned-tab.svg?v=00rdjbaPyz"
                  color="#5bbad5">
            <link rel="shortcut icon"
                  href="<?php echo get_stylesheet_directory_uri(); ?>/img/favicon/favicon.ico?v=00rdjbaPyz">
            <meta name="msapplication-config"
                  content="<?php echo get_stylesheet_directory_uri(); ?>/img/favicon/browserconfig.xml?v=00rdjbaPyz">
