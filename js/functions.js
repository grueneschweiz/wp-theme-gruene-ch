...
(function($) {
  ...
  function Misc() {
    ...
    this.setHeaderTextHight = function setHeaderTextHight() {
      ...
      width = $line1.outerWidth() > $line2.outerWidth() ?
          $line1.outerWidth() :
          $line2.outerWidth();
  ...
  function Nav() {
    ...
    this.initiateMobileEvents = function initiateMobileEvents() {
      ...
      $('nav#side-menu ul.menu li.menu-item-has-children > a').
     ...
     */
    this.handleHideNshowItemsWithChildren = function handleHideNshowItemsWithChildren(
        el, event) {
      ...
      if ($sub_menu.hasClass('show-children')) {
        ...
        // show them
        $sub_menu.slideToggle().addClass('show-children');
    ...
    this.showCurrentTree = function showCurrentTree() {
      $('nav#side-menu').
          find('.current-menu-ancestor, .current-menu-item').
          parent('ul').
          show().
    ...
    this.initiateFooterHideNshow = function initiateFooterHideNshow() {
      ...
      //menu item with children
      $('div.footer-widget-area ul.menu li.menu-item-has-children > a').
          click(function(event) {
            self.handleHideNshowItemsWithChildren(this, event);
          });
    };
  ...
  function Campaign() {
    ...
    this.init = function init() {
      ...
      $('.gruene-campaign').dialog({
        ...
        minWidth: layout_max_width > window_width - margin ?
            window_width - margin :
            layout_max_width,
    ...
    this.setDialogHeight = function setDialogHeight() {
      ...
      var margin = 20,
          ...
          dialog_height = viewport_height < content_height ?
              viewport_height :
              content_height,
    ...
    this.setDialogWidth = function setDialogWidth() {
      ...
      var layout_max_width = 629,
          margin = 20,
          window_width = $(window).width(),
          dialog_width = window_width - margin < layout_max_width ?
              window_width - margin :
              layout_max_width;
