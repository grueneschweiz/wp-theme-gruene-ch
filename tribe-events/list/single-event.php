...
<?php gruene_the_post_thumbnail(); ?>
    ...
    <div class="tribe-events-list-title-meta-wrapper">
        ...
        <h2 class="tribe-events-list-event-title entry-title summary tribe-events-<?php echo get_theme_mod( 'title_caps', 'title_caps_none' ); ?>">
            <a class="url" href="<?php echo esc_url( tribe_get_event_link() ); ?>" title="<?php the_title() ?>"
               rel="bookmark">
				<?php the_title() ?>
            </a>
        </h2>
    ...
    </div><!-- .tribe-events-list-title-meta-wrapper -->
...
<?php do_action( 'tribe_events_before_the_content' ) ?>
    <div class="tribe-events-list-event-description tribe-events-content description entry-summary">
        ...
        <a href="<?php echo esc_url( tribe_get_event_link() ); ?>" class="tribe-events-read-more"
           rel="bookmark"><?php esc_html_e( 'Find out more', 'tribe-events-calendar' ) ?> &raquo;</a>
